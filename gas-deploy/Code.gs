...
// ポータル側の「保存した検索条件」で確実に絞り込まれているMUSTタグIDだけを列挙する
// （src/mockData.ts の tags と対応。t1 駅徒歩15分以内 / t2 2LDK以上 / t3 2口ガスコンロ以上 /
//   t4 家賃25万円以内 / t5 バイク置き場 / t6 浴室乾燥機 / t7 宅配ボックス / t8 大型スーパー近く）
//
// 2026-08-11 時点のアットホーム保存条件（東横線 渋谷〜自由が丘・田園都市線 渋谷〜二子玉川／
// 〜30万円 管理費込／2LDK以上／45㎡以上／駅徒歩20分以内／2口以上コンロ・浴室乾燥機・宅配ボックス）
// で保証されるのは t2 / t3 / t6 / t7 の4つのみ。
//   t1 … 徒歩20分に緩和したため保証されない
//   t4 … 家賃上限を30万円で運用すると決めたため保証されない
//   t5 … 該当171件と少なく通知が来なくなるため条件から除外
//   t8 … 検索条件から除外（内見時の手動確認に回す）
// 満たしていない条件を「満たした」と記録しないため、保証されないものは貼らない。
// 保存条件を変更したら、この配列も必ず合わせて更新すること。
var MUST_TAGS_COVERED = ['t2', 't3', 't6', 't7'];
